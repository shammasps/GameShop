<%@ Page Title="" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="AdminHomePage.aspx.cs" Inherits="ShopingWebSiteFirstProject.AdminHomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="w-100" style="margin-left: 100px;">
        ...
        <tr>
            <td>
                <asp:LinkButton ID="LinkButton5" runat="server" Font-Bold="True" PostBackUrl="~/Add_Categories.aspx" Font-Size="X-Large">Add Category</asp:LinkButton>
            </td>
            <td>
                <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" PostBackUrl="~/Edit_Category.aspx" Font-Size="X-Large">Edit Category</asp:LinkButton>
            </td>
            <td>
            ...
            <td>
                <asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" PostBackUrl="~/Edit_Games.aspx" Font-Size="X-Large">Edit Games</asp:LinkButton>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
